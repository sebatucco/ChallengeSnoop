...
using ChallengeSnoop.Infraestructure.Service;
using ChallengeSnoop.Infraestructure.UoW;
...
builder.Services.AddDbContext<DataContext>(options =>
    options.UseSqlServer(builder.Configuration.GetConnectionString("ChallengeSnoop")));
